...
class ContactForm(forms.Form):
    ...
    name = forms.CharField(required=True, label='', label_suffix="", max_length=100, widget=forms.TextInput(attrs={'class' : 'contactSearchBar', 'placeholder': _('Imię i nazwisko')})   )
