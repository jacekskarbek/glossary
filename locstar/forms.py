...
class ContactForm(forms.Form):
    ...
    email = forms.EmailField(required=True, label='', label_suffix="", max_length=100, widget=forms.EmailInput(attrs={'class' : 'contactSearchBar', 'placeholder': _(u'Adres email')}), localize=True    )
